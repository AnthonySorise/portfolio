...
if(window.innerWidth > 1366 || window.innerHeight > 1366) {
    (function (t, e) {
        "use strict";
        ...
        if (!i.TweenLite) {
            ...
            r._init = function () {
                var t, e, i, s, n, r = this.vars, a = this._overwrittenProps, o = this._duration,
                    l = !!r.immediateRender, h = r.ease;
                if (r.startAt) {
 ...
 **/
    ...
    (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
        ...
        _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (t) {
            var e, i, s, r = _gsScope.GreenSockGlobals || _gsScope, n = r.com.greensock, a = 2 * Math.PI,
                o = Math.PI / 2, h = n._class, l = function (e, i) {
...
// [© Codrops 2014](http://www.codrops.com)
    !function () {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function (n) {
            var t = (new Date).getTime(), i = Math.max(0, 16 - (t - e)), o = window.setTimeout(function () {
                n(t + i)
            }, i);
            return e = t + i, o
        ...
        function e() {
            ...
            for (var e = 0; s > e; e += s / 18) for (var n = 0; u > n; n += u / 18) {
                var t = e + Math.random() * s / 18, i = n + Math.random() * u / 18,
                    o = {x: t, originX: t, y: i, originY: i};
                v.push(o)
            }
        ...
        function l(e) {
            if (e.active) for (var n in e.closest) h.beginPath(), h.moveTo(e.x, e.y), h.lineTo(e.closest[n].x, e.closest[n].y), h.strokeStyle = "rgba(235,235,235," + e.active + ")", h.stroke()
        }
